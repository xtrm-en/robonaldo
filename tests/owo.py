...
parser.add_argument("--game-controller", "-g", type=str, default="172.19.39.223")
...
with rsk.Client(args.game_controller, args.key) as client:
    ...
    def try_goto(team, number, x, y):
        ...
        except rsk.client.ClientError as _:
            pass

    while True:
        positive = not client.referee["teams"][team]["x_positive"]
