...
def translate(msg: mido.messages.Message) -> (float, float):
    hacky_shit = vars(msg)
    if 'note_on' not in hacky_shit['type']:
        return (-1, -1)

    freq = hacky_shit['note']
    duration = hacky_shit['time'] * 1000 # its in seconds
    return (freq, duration)


mid = mido.MidiFile('tests/yes.mid')
# for msg in mid.play():
#     freq, duration = translate(msg)
